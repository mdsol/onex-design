...
<Canvas>
    <Story id='bootstrap-components-offcanvas--start-placement' />
    <Story id='bootstrap-components-offcanvas--end-placement' />
    <Story id='bootstrap-components-offcanvas--top-placement' />
    <Story id='bootstrap-components-offcanvas--bottom-placement' />
</Canvas>
...
<Canvas>
    <Story id='bootstrap-components-offcanvas--enable-backdrop' />
    <Story id='bootstrap-components-offcanvas--disable-backdrop' />
    <Story id='bootstrap-components-offcanvas--enable-scrolling' />
    <Story id='bootstrap-components-offcanvas--enable-scrolling-backdrop' />
</Canvas>
