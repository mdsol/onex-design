...
<Canvas>
    <Story id='bootstrap-components-modal--static-markup' />
</Canvas>
...
<Canvas>
    <Story id='bootstrap-components-modal--static-backdrop' />
</Canvas>
...
<Canvas>
    <Story id='bootstrap-components-modal--without-animation' />
</Canvas>
...
<Canvas>
    <Story id='bootstrap-components-modal--vertically-centered' />
</Canvas>
...
<Canvas>
    <Story id='bootstrap-components-modal--sizes' />
</Canvas>
...
<Canvas>
    <Story id='bootstrap-components-modal--fullscreen' />
</Canvas>
...
<Canvas>
    <Story id='bootstrap-components-modal--custom-sizing' />
</Canvas>
