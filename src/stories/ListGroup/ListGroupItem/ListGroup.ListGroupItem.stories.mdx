...
<Canvas>
    <Story id="components-listgroup-listgroupitem--primary" />
    <Story id="components-listgroup-listgroupitem--secondary" />
    <Story id="components-listgroup-listgroupitem--success" />
    <Story id="components-listgroup-listgroupitem--warning" />
    <Story id="components-listgroup-listgroupitem--danger" />
    <Story id="components-listgroup-listgroupitem--info" />
    <Story id="components-listgroup-listgroupitem--light" />
    <Story id="components-listgroup-listgroupitem--dark" />
</Canvas>
...
<Canvas>
    <Story id="components-listgroup-listgroupitem--active" />
</Canvas>
...
<Canvas>
    <Story id="components-listgroup-listgroupitem--disabled" />
</Canvas>
