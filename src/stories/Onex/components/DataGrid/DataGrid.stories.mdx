...
Also, you can use callback ```dataGridControlProps.onFilter``` - which returns filteredRows and ```dataGridControlProps.getActiveFilters``` - function for get current value of selected filters.
