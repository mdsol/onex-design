...
<ul>
  ...
  <li><b>onHandleClick</b> - <code>type: () => void, default: () => {}</code> function call back to click button which is visible if the file was loaded with an error (function doesn't have code for it you should write your own)</li>
</ul>
