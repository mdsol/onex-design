...
<Canvas>
    <Story id='components-textfield--small' />
    <Story id='components-textfield--large' />
</Canvas>

### TextField has clear button

<Canvas>
    <Story id='components-textfield--clear-button' />
</Canvas>

### TextField has default icon, custom icon

<Canvas>
    <Story id='components-textfield--default-icon' />
    <Story id='components-textfield--icon' />
</Canvas>
...
<Canvas>
    <div style={{display: 'flex', alignItems: 'flex-start', gap: '25px'}}>
        <Story id='components-textfield--error-message' />
        <Story id='components-textfield--required' />
    </div>
</Canvas>
...
<Canvas>
    <Story id='components-textfield--disabled' />
</Canvas>

### Read only TextField

<Canvas>
    <Story id='components-textfield--read-only' />
</Canvas>
