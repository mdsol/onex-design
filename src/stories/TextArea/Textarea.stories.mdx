...
<Canvas>
    <Story id='components-textarea--small' />
    <Story id='components-textarea--large' />
</Canvas>

### Textarea with label text

<Canvas>
    <Story id='components-textarea--label' />
</Canvas>

### Textarea with help text and max length

<Canvas>
    <Story id='components-textarea--help-text' />
    <Story id='components-textarea--max-length' />
</Canvas>

### Textarea with error and max length

<Canvas>
    <Story id='components-textarea--error-message' />
    <Story id='components-textarea--max-length-error' />
</Canvas>
...
<Canvas>
    <Story id='components-textarea--read-only' />
</Canvas>
